# -*- Mode: perl -*-
#
# $Id: Flags.pm,v 0.1 2001/03/25 16:21:45 ram Exp $
#
...
Devel::Datum::Flags - Flag Constants
...
This module is used internally by C<Devel::Datum>.  It defines the
constants that are exported and made available automatically to all
users of C<Devel::Datum>.
